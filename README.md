...
`공유 파일 가져오기`에서 JSON을 선택하고 미리본 뒤 가져옵니다. 설치 후 원하는 자리에 적용하며, 재가져오기는 기존 캐릭터 업데이트가 아닌 새 로컬 복사본입니다. 예제는 [솔·달 캐릭터팩](examples/character-packs/sol-and-dal.comet-character.json)입니다.
